...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/isDate.mjs");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/isValid.mjs");
...
function ProjectList() {
    ...
    class Project {
        constructor(name, tasks = [], date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.endOfToday)(), description) {
            this.name = name;
            this.tasks = tasks;
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__.isDate)(date)) {
                this.date = date;
            } else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.isValid)(date)) {
                this.date = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.parse)(date, "yyyy-MM-dd", new Date());
            } else {
                this.date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.endOfToday)();
            }
            this.description = description;
        };

        get dateStr() {
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(this.date, "yyyy-MM-dd");
        };
    }
    ...
    const updateActiveProject = (name, date, description) => {
        ...
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__.isDate)(date)) {
            ...
            projects[activeProject].date = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.parse)(date, "yyyy-MM-dd", new Date());
        } else {
            projects[activeProject].date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.endOfToday)();
        };
    ...
    const getDate = (index) => {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(projects[index].date, "yyyy-MM-dd");
    };
...
class Task {
    constructor(name, date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.endOfToday)(), description) {
        this.name = name;
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__.isDate)(date)) {
            this.date = date;
        } else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.isValid)(date)) {
...
function test() {
    console.log(Storage.getItem("project"));
};
...
(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.test)();
        ...
        projectDivList.forEach((element) => {
            ...
            element.querySelector(".edit-button").addEventListener("click", () => {
                ...
                addProjectDialog.querySelector(".confirm").addEventListener("click", () => {
                    ...
                    element.querySelector(".project-date").textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(projectList.getActiveProject().date, "yyyy-MM-dd");
            ...
            element.querySelector(".edit-button").addEventListener("click", () => {
                ...
                addTaskDialog.querySelector(".confirm").addEventListener("click", () => {
                    ...
                    element.querySelector(".task-date").textContent =
                        (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(projectList.getProjects()[projectIndex].tasks[taskIndex].date, "yyyy-MM-dd");
