...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,uBAAuB;AAC3B;;AAEA;;;IAGI,UAAU;IACV,SAAS;AACb;;AAEA;IACI,iBAAiB;IACjB,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;IAChB,mBAAmB;AACvB;;AAEA;;IAEI,aAAa;IACb,qCAAqC;IACrC,6BAA6B;IAC7B,gBAAgB;IAChB,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,sBAAsB;IACtB,YAAY;AAChB;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,6BAA6B;IAC7B,gBAAgB;IAChB,mBAAmB;AACvB;;AAEA;;IAEI,eAAe;IACf,oBAAoB;IACpB,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;;;;;;IAMI,eAAe;AACnB;;AAEA;;;;IAII,eAAe;IACf,cAAc;IACd,iBAAiB;IACjB,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,uBAAuB;IACvB,mBAAmB;IACnB,aAAa;IACb,aAAa;IACb,sBAAsB;IACtB,QAAQ;AACZ;;AAEA;;;;IAII,YAAY;IACZ,aAAa;AACjB;;AAEA;;IAEI,eAAe;IACf,aAAa;IACb,QAAQ;AACZ;;AAEA;IACI,eAAe;IACf,YAAY;AAChB;;AAEA;;;IAGI,uBAAuB;IACvB,mBAAmB;IACnB,aAAa;IACb,UAAU;AACd;;AAEA;;;IAGI,aAAa;IACb,sBAAsB;IACtB,QAAQ;AACZ;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,sBAAsB;AAC1B","sourcesContent":["* {\n    font-family: sans-serif;\n}\n\nh1,\np,\nbutton {\n    padding: 0;\n    margin: 0;\n}\n\nbody {\n    margin-left: 16px;\n    margin-right: 16px;\n}\n\nbody h1 {\n    margin-top: 16px;\n    margin-bottom: 16px;\n}\n\n.project-div,\n.task-div {\n    display: grid;\n    grid-template-columns: 50px 1fr 100px;\n    border-top: 1px solid #797a80;\n    padding-top: 8px;\n    padding-bottom: 8px;\n}\n\n.button-container {\n    display: flex;\n    flex-direction: column;\n}\n\n#add-project {\n    background-color: #fff;\n    border: none;\n}\n\n#add-project:hover {\n    color: #797a80;\n}\n\n#button-container {\n    border-top: 1px solid #797a80;\n    padding-top: 8px;\n    padding-bottom: 8px;\n}\n\n.project-checkbox,\n.task-checkbox {\n    margin-top: 4px;\n    justify-self: center;\n    width: 16px;\n    height: 16px;\n}\n\n.task-div {\n    margin-left: 32px;\n}\n\n.project-title,\n.task-title,\n#add-project,\n#project-title,\n#task-title,\n#edit-task-title {\n    font-size: 24px;\n}\n\n.project-description,\n.project-date,\n.task-description,\n.task-date {\n    font-size: 16px;\n    color: #797a80;\n    margin-left: 16px;\n    margin-bottom: 4px;\n    margin-top: 4px;\n}\n\n#add-project-form {\n    border: solid 1px black;\n    border-radius: 12px;\n    padding: 12px;\n    display: flex;\n    flex-direction: column;\n    gap: 8px;\n}\n\ninput,\ninput:focus,\ntextarea,\ntextarea:focus {\n    border: none;\n    outline: none;\n}\n\n#add-project-button-container,\n#add-task-button-container {\n    align-self: end;\n    display: flex;\n    gap: 8px;\n}\n\n.add-project-button {\n    font-size: 16px;\n    padding: 4px;\n}\n\n#add-task-dialog,\n#edit-task-dialog,\n#add-project-dialog {\n    border: solid 1px black;\n    border-radius: 12px;\n    padding: 12px;\n    width: 70%;\n}\n\n#add-task-form,\n#edit-task-form,\n#add-project-form {\n    display: flex;\n    flex-direction: column;\n    gap: 8px;\n}\n\ntextarea {\n    resize: none;\n}\n\n.date {\n    align-self: flex-start;\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/endOfToday.mjs");
...
function ProjectList() {
    ...
    function Project(name = "project", tasks = [], date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.endOfToday)(), description) {
        this.name = name;
        this.tasks = tasks;
        this.date = date,
    ...
    const getDate = (index) => {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(projects[index].date, "yyyy-MM-dd");
    }
...
function Task(name, date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.endOfToday)(), description) {
    this.name = name;
    this.date = date;
    this.description = description;
}
...
console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(myDate, "yyyy-MM-dd"));
console.log(myDate);
const newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.parse)("2024-01-01", "yyyy-MM-dd", new Date());
console.log(newDate);
...
function ScreenController() {
    ...
    const updateScreen = () => {
        ...
        for (let i = 0; i < list.length; i++) {
            ...
            projectDateP.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(list[i].date, "yyyy-MM-dd");
            ...
            for (let j = 0; j < list[i].tasks.length; j++) {
                ...
                taskDateP.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(list[i].tasks[j].date, "yyyy-MM-dd");
        ...
        taskDivList.forEach((element) => {
            ...
            element.querySelector(".edit-button").addEventListener("click", () => {
                ...
                addTaskDialog.querySelector(".confirm").addEventListener("click", () => {
                    projectList.getProjects()[projectIndex].tasks[taskIndex] = new _projects_js__WEBPACK_IMPORTED_MODULE_0__.Task(
